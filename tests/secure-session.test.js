...
describe('key exchange', () => {
  ...
  // shared secret key , shared public key
  // rx will be used by the client to receive data from the server
  // tx will by used by the client to send data to the server
  let rx, tx  
